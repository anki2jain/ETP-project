...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="addprod.php">add prod </a>
      </li>
     
      <li class="nav-item">
        <a class="nav-link " href="addsubprod.php">add subprod</a>
      </li>

  <li class="nav-item">
        <a class="nav-link " href="addcourse.php"></a>
      </li>
